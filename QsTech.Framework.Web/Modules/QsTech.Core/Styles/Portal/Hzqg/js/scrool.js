...
$(function() {
	...
	$("#banner .num span").css("opacity",0.2).mouseover(function() {
		index = $("#banner .num span").index(this);
		showPics(index);
	...
	function showPics(index) { //普通切换
		...
		$("#banner .num span").stop(true,false).animate({"opacity":"0.4"},300).eq(index).stop(true,false).animate({"opacity":"1"},300); //为当前的按钮切换到选中的效果
	}
});